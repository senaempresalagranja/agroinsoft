...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B7', 'Numero Documento')
            ->setCellValue('C7', 'Nombres')
            ->setCellValue('D7', 'Apellidos')
            ->setCellValue('E7', 'Fecha Nacimiento')
            ->setCellValue('F7', 'Cargo')
            ->setCellValue('G7', 'Telefono')
            ->setCellValue('H7', 'Email')
            ->setCellValue('I7', 'Dirreccion');
...
$Cedula=$_POST["Cedula"];
            ...
            $objPHPExcel->getActiveSheet()->setTitle('Consulta_Cuentadante');
$objPHPExcel->setActiveSheetIndex(0);
...
header('Content-Disposition: attachment;filename="Consulta_Cuentadante.xls"');
