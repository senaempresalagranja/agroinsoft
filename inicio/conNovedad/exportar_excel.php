...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B7', 'Tipo Novedad')
            ->setCellValue('C7', 'Fecha')
            ->setCellValue('D7', 'Responsable Novedad')
            ->setCellValue('E7', 'Cedula Responsable')
            ->setCellValue('F7', 'Especificaciones')
            ->setCellValue('G7', 'Prioridad');
...
$fecha2=$_POST["fecha2"];
            ...
            $objPHPExcel->getActiveSheet()->setTitle('Consulta_Novedades');
$objPHPExcel->setActiveSheetIndex(0);
...
header('Content-Disposition: attachment;filename="Consulta_Novedades.xls"');
