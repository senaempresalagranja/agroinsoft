...
$sql="UPDATE `maqyequipo` SET `nomElemento`='$nomElemento',`codInventario`='$codInventario',`codInterno`='$codInterno',`marElemento`='$marElemento',`seriale`='$seriale',`modelo`='$modelo',`capacidad`='$capacidad',`fecAdquisicion`='$fecAdquisicion',`idUbicacion`='$idUbicacion',`estElemento`='$estElemento',`idCuentadante`='$idCuentadante',`numFicTecnica`='$numFicTecnica',`idClasificacion`='$idClasificacion',`imagen`='$imagen' WHERE codInterno='$codInterno'";
		

$respuesta=mysqli_query($conexion,  $sql)  or die ("problemas al insertar");
if($respuesta==true){
