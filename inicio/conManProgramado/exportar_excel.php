...
$fecha2=date("d-m-Y",strtotime($fecha2));
            $objPHPExcel->getActiveSheet()->setTitle('Mantenimientos_Programados');
$objPHPExcel->setActiveSheetIndex(0);
...
header('Content-Disposition: attachment;filename="Mantenimientos_Programados.xls"');
