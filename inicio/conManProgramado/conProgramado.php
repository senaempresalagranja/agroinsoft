...
include '../../login/inicio_sesion.php';
 ...
 ?>
	...
	<head>
		<title>Consultar Mantenimientos Programados</title>
		<meta charset="utf-8">
...
<header>
    <div class="menu_bar">
      <a href="#" class="bt-menu"><span class="icon-list2"></span>AGROINSOFT <h3>Mantenimientos Programados</h3></a>
    </div>
      ...
      <ul>
        <li id="logo"><img src="../../img/isologo.png" class="isologo"></img><a href="#" >AGROINSOFT</a>
		   ...
		   <div class="itms-menu">
                       ...
                       <h2>Consultar Mantenimientos Programados</h2>
                 	 </div>
        </li>
	<?php 
...
<div class="botones">
	...
	<button class="cam-button" onclick="exportar_pdf()"  type="button"  class="btn btn-3 " value="exportar pdf">
		<img class="icon" src="../iconos/exppdf.svg" alt="x" />
	</button> 
	
	<button class="cam-button" onclick="exportar_excel() " class="btn btn-3 " value="exportar excel" type="button">
		<img class="icon"  src="../iconos/expexcel.svg" alt="x" />
	</button>
	...
	<div id="contenedor_consulta"></div>
		...
		$insertar="SELECT * FROM `ayuda` WHERE id_formulario=13 order by ayuda.terAyuda";
...
if (validar_nombre()==true || validar_codigo()==true  || validar_fecha()==true ) {	
