...
(function ($) {
    ...
    var CAPTION_TEMPLATE = '<div class="form-control file-caption {class}">\n' +
        '   <span class="icno  icon-file-empty"></span> <span class="file-caption-name"></span>\n' +
        '</div>';
    ...
    FileInput.prototype = {
            ...
            for (var i = 0; i < total; i++) {
                (function (file) {
                    ...
                    if (preview.length > 0 && (fileType == "any" ? (isImg || isTxt) : (fileType == "text" ? isTxt : isImg)) && typeof FileReader !== "undefined") {
                        ...
                        preview.append("\n" + '<div class="file-preview-frame"><div class="file-preview-other"><h2><i class="icon icon-file"></i></h2>' + caption + '</div></div>');
                    }
                })(tfiles[i]);
            }
        ...
        renderUpload: function () {
            ...
            if (isEmpty(self.uploadUrl)) {
                content = '<button type="submit" name="boton" class="' + self.uploadClass + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</button>';
            }
            else {
    ...
    $.fn.fileinput.defaults = {
        ...
        removeIcon: '<i class="icon icon-bin"></i> ',
        ...
        msgProgress: 'Cargando Imagen 100% de {file}',
