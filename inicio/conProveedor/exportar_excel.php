...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A7', 'Nombre Proveedor')
            ->setCellValue('B1','AGROINSOFT V.2')
            ->setCellValue('B7', 'NIT')
            ->setCellValue('C7', 'Telefono')
            ->setCellValue('D7', 'Dirreccion')
            ->setCellValue('E7', 'Correo')
            ->setCellValue('F7', 'Sitio Web');
...
$NIT=$_POST["NIT"];
            ...
            $objPHPExcel->getActiveSheet()->setTitle('Consulta_Proveedor');
$objPHPExcel->setActiveSheetIndex(0);
...
header('Content-Disposition: attachment;filename="Consulta_Proveedor.xls"');
