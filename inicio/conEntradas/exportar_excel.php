...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B7', 'Fecha Entrada')
            ->setCellValue('C7', 'Estado Maquina')
            ->setCellValue('D7', 'Ubicacion Entrada')
            ->setCellValue('E7', 'Procedimiento')
            ->setCellValue('F7', 'Responsable Entrada')
            ->setCellValue('G7', 'Cedula Responsalbe');
...
$fecha2=$_POST["fecha2"];
            ...
            $objPHPExcel->getActiveSheet()->setTitle('Consulta_Entradas');
$objPHPExcel->setActiveSheetIndex(0);
...
header('Content-Disposition: attachment;filename="Consulta_Entradas.xls"');
