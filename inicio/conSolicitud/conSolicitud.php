...
<header>
    <div class="menu_bar">
      <a href="#" class="bt-menu"><span class="icon-list2"></span>AGROINSOFT <h3>Consultar Solicitud</h3></a>
    </div>
...
<div id="contenedor"></div>
	...
	<div id="contenedor_consulta"></div>
		...
		$insertar="SELECT * FROM `ayuda` WHERE id_formulario=19 order by ayuda.terAyuda";
