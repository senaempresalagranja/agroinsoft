...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B7', 'Tipo Mantenimiento')
            ->setCellValue('C7', 'Proveedor Mantenimiento')
            ->setCellValue('D7', 'Fecha')
            ->setCellValue('E7', 'Procedimiento')
            ->setCellValue('F7', 'Recomendaciones')
            ->setCellValue('G7', 'Garantia')
            ->setCellValue('H7', 'Responsable Mantenimiento')
            ->setCellValue('I7', 'Cedula Responsable');
...
header('Content-Disposition: attachment;filename="Consulta_Mantenimiento_Ejecutados.xls"');
