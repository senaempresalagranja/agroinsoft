...
<header>
    <div class="menu_bar">
      ...
      <a href="#" class="bt-menu"><span class="icon-list2"></span>AGROINSOFT <h3>Mantenimiento Ejecutado</h3></a>
    </div>
      ...
      <ul>
        <li id="logo"><img src="../../img/isologo.png" class="isologo"></img><a href="#" >AGROINSOFT</a>
		   ...
		   <div class="itms-menu">
                       ...
                       <h2>Consultar Mantenimiento Ejecutado</h2>
                 	 </div>
        </li>
	<?php 
...
<div class="botones">
	...
	<div id="contenedor_consulta"></div>
		...
		$insertar="SELECT * FROM `ayuda` WHERE id_formulario=12 order by ayuda.terAyuda";
