...
<div class="botones">
	...
	<div class="overlay-container">
		...
		$insertar="SELECT * FROM `ayuda` WHERE id_formulario=15 order by ayuda.terAyuda";
...
function exportar_excel() {
	var formualrio=document.getElementById("formulario").action="exportar_excel.php";
	var formualrio=document.getElementById("formulario").submit();

}

function exportar_pdf() {
	var formualrio=document.getElementById("formulario").action="exportar_pdf.php";
	var formualrio=document.getElementById("formulario").submit();
