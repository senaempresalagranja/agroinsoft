...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A7', 'Nombre Maquina')
            ->setCellValue('B1','AGROINSOFT V.2')
            ->setCellValue('B7', 'Fecha Salida')
            ->setCellValue('C7', 'Fecha Limite Regreso')
            ->setCellValue('D7', 'Ubicacion')
            ->setCellValue('E7', 'Proveedor')
            ->setCellValue('F7', 'Cuentadante')
            ->setCellValue('G7', 'Cedula Cuentadante')
            ->setCellValue('H7', 'Destino');
...
header('Content-Disposition: attachment;filename="Consulta_Salidas.xls"');
