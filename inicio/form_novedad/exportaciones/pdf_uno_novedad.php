...
// set text shadow effect
					...
					$query="SELECT nomElemento, codInterno, tipNovedad, fecNovedad, perNovedad, cedPerNovedad, espNovedad, prioridad FROM `novedades` INNER JOIN maqyequipo ON novedades.idMaqEquipo=maqyequipo.idMaqEquipo where novedades.idMaqEquipo=$id_maquina ";
...
<tr><td> <b>TIPO NOVEDAD: </b>$tipNovedad   </td></tr>
<tr><td> <b>FECHA NOVEDAD: </b>$fecNovedad </td></tr>
<tr><td> <b>QUIEN REGISTRÓ NOVEDAD: </b>$perNovedad   </td></tr>
<tr><td> <b>IDENTIFICACIÓN: </b>$cedPerNovedad   </td></tr>
<tr><td> <b>ESPECIFICACION NOVEDAD: </b> $espNovedad    </td></tr>
<tr><td> <b>NIVEL DE PRIORIDAD: </b>$prioridad </td></tr>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Reporte Novedad.pdf', 'D');
