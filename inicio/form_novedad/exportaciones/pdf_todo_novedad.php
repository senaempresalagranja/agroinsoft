...
$sql="SELECT nomElemento, codInterno, tipNovedad, fecNovedad, perNovedad, cedPerNovedad, espNovedad, prioridad FROM `novedades` INNER JOIN maqyequipo ON novedades.idMaqEquipo=maqyequipo.idMaqEquipo";
...
// NOMBRE DEL ARCHIVO
$pdf->Output('Reporte Novedades.pdf', 'D');
