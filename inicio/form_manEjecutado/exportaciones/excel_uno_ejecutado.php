...
<?PHP
                $id_maquina=$_POST["id_maquina"];
     			$idTipMantenimiento=$_REQUEST['idTipMantenimiento'];
     			$idProveedor=$_REQUEST['idProveedor'];
     			$fecEjecutado=$_REQUEST['fecEjecutado'];
     			$procedimiento=$_REQUEST['procedimiento'];
     			$recomendaciones=$_REQUEST['recomendaciones'];
     			$garantia=$_REQUEST['garantia'];
     			$nomPerMantenimiento=$_REQUEST['nomPerMantenimiento'];
     			$cedPerMantenimiento=$_REQUEST['cedPerMantenimiento'];
